...
public class AutoRed extends OpMode {
    ...
    public Pose startPositon = new Pose(10,10, Math.toRadians(45)),
            shootPosition= new Pose( 41, -31, Math.toRadians(50)),
            firstIntakePosition = new Pose(51, -32, Math.toRadians(135)),
            firstIntakeTake = new Pose(51, 13, Math.toRadians(135)),
            homePosition = new Pose(45, 5, Math.toRadians(-90));
